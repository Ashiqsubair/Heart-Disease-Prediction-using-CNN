<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="doctorlabreport.aspx.cs" Inherits="Heart_Disease_Prediction_Portal_Final.doctorclinic" %>
    ...
    <table class="style3">
        ...
        <tr>
            ...
            <td>
                &nbsp;</td>
            <td>
                EMR no:<asp:Label ID="lbl_emr" runat="server" ForeColor="Black"></asp:Label>
            </td>
            <td class="style18">
                &nbsp;</td>
            <td>
        ...
        <tr>
            ...
            <td class="style8">
                Patient Name :&nbsp;
                <asp:TextBox ID="txt_patiename" runat="server" Width="152px"></asp:TextBox>
            </td>
            <td class="style19">
                &nbsp;</td>
            <td class="style8">
        ...
        <tr>
            ...
            <td class="style17">
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                    DataSourceID="SqlDataSource1" Width="354px" ForeColor="Black" 
                    GridLines="None">
                    <Columns>
