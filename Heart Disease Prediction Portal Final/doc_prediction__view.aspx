<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="doc_prediction__view.aspx.cs" Inherits="Heart_Disease_Prediction_Portal_Final.doc_prediction__view" %>
    ...
    <table class="style3">
        ...
        <tr>
            ...
            <td>
                &nbsp;</td>
            <td>
                <asp:Label ID="lbl_docname" runat="server"></asp:Label>
            </td>
            <td>
                &nbsp;</td>
        </tr>
