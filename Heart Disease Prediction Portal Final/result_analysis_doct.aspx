<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="result_analysis_doct.aspx.cs" Inherits="Heart_Disease_Prediction_Portal_Final.result_analysis_doct" %>
        ...
        <tr>
            ...
            <td>
                <asp:Chart ID="Chart1" runat="server" Width="411px">
                    <series>
                        <asp:Series ChartType="Pie" Legend="Healthy" Name="Series1">
                        </asp:Series>
                    </series>
                    <chartareas>
                    ...
                    <Legends>
                        <asp:Legend Name="Healthy">
                        </asp:Legend>
                        <asp:Legend Name="Disease">
                        </asp:Legend>
                    </Legends>
                </asp:Chart>
            </td>
